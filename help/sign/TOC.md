...
+ Introducción {#getting-started}
   ...
   + Enviar {#getting-started-sending}
      ...
      + [Comienza a usar Acrobat Sign](sign-beginner-tutorials/new-sender.md)
      + [Envía un documento a un único firmante](sign-beginner-tutorials/send-to-single-recipient.md)
      + [Enviar a varios firmantes](sign-beginner-tutorials/send-to-multiple-recipients.md)
      ...
      + [Modificar un documento después de enviarlo](sign-beginner-tutorials/modify-in-flight.md)
      ...
      + [Crear una plantilla reutilizable](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/admin-set-up/getting-started-admin/create-a-template.html)
...
+ Tareas avanzadas {#advanced-tasks}
   ...
   + Enviar {#advanced-tasks-sending}
      + [Asignar un orden de firma](sign-advanced-users/setting-up-routing.md)
      ...
      + [Crear un flujo de trabajo personalizado](https://experienceleague.adobe.com/en/docs/document-cloud-learn/sign-learning-hub/advanced-tasks/advanced-tasks-managing/creating-a-report)
   ...
   + Administrar {#advanced-tasks-managing}
      + [Informes y uso de transacciones](sign-advanced-users/creating-a-report.md)
...
+ Administrar {#admin-set-up}
   ...
   + Introducción {#getting-started-admin}
      + [Introducción para nuevos administradores](admin/get-started-admin.md)
      ...
      + [Habilitar reglas automáticas de asignación de usuarios](admin/automatic-assignment-rules.md)
      ...
      + [Crear una plantilla reutilizable](sign-advanced-users/create-a-template.md)
      + [Informes y uso de transacciones](https://experienceleague.adobe.com/en/docs/document-cloud-learn/sign-learning-hub/advanced-tasks/advanced-tasks-managing/creating-a-report)
      ...
      + [Crear un flujo de trabajo personalizado](admin/building-a-custom-workflow.md)
      ...
      + [Configurar y controlar Modificar acuerdo](admin/configure-modify-agreement.md)
...
+ Móvil {#mobile}
   ...
   + Tutoriales para móviles {#mobile-tutorials}
      ...
      + [Vista compatible con dispositivos móviles](mobile/mobile-friendly.md)
      + [Crear vista compatible con dispositivos móviles](mobile/create-mobile-friendly.md)
