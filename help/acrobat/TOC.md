...
+ Introducción {#get-started}
  ...
  + Trabaja de forma más inteligente con la IA {#ai}
    ...
    + [Crear un podcast](getting-started/podcast.md)
...
+ Serie de accesibilidad {#accessibility-tutorials}
  + [Información general](accessibility-series/accessibility-overview.md)
  ...
  + [Crear un PDF accesible en Acrobat](accessibility-series/accessible-acrobat.md)
  + [Conceptos básicos del etiquetado](accessibility-series/basics-tagging.md)
  ...
  + [Listas complejas](accessibility-series/complex-lists.md)
  + [Tablas complejas](accessibility-series/complex-tables.md)
...
+ Analizador en Acrobat Studio {#analyzer}
  ...
  + [Usar colecciones](analyzer/collections.md)
  + [Trabajar con atributos](analyzer/attributes.md)
...
+ Casos prácticos {#use-cases}
  ...
  + Línea de negocio {#lob}
    ...
    + Marketing {#marketing}
      + [Información general](use-cases/lob/marketing/marketing-overview.md)
      + [Agiliza el lanzamiento de productos con Acrobat Studio](use-cases/lob/marketing/marketing-product-launch.md)
    + Ventas {#sales}
      + [Información general](use-cases/lob/sales/sales-overview.md)
      + [Convierte la inteligencia del cliente en activos de ventas ganadores](use-cases/lob/sales/sales-insights.md)
  + Organismos públicos {#gov}
    ...
    + Cinco consejos para trabajar con Acrobat desde cualquier parte {#tips}
      ...
      + [Consejo n.º 4: Trabaja con formularios y firmas](use-cases/gov/work-with-forms-and-signatures.md)
      + [Consejo n.º 5: Escanea y edita en dispositivos móviles](use-cases/gov/scan-and-edit-on-mobile.md)
