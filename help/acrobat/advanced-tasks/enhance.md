...
1. En la sección Fuente, seleccione Calibri negrita en el **Nombre** menú desplegable.
...
1. Seleccionar **Insertar número de página** en el **Centrar texto del pie de página** caja.
1. Tipo *Revisión 3.0* en el **Texto del pie derecho** caja.
...
1. Seleccionar **OK** para aplicar el nuevo pie al PDF.
